...
```javascript
npm install @hixbe/material-symbols-outlined
```

Within your app entry file or site component, import it in.

```javascript
import "@hixbe/material-symbols-outlined"; // Defaults to weight 400
import "@hixbe/material-symbols-outlined/400.css"; // Specify weight
import "@hixbe/material-symbols-outlined/400-italic.css"; // Specify weight and style
```
...
> Note: `italic` may not be supported by all fonts. To learn more about what weights and styles are supported, please visit the [Hixbe website](https://hixbe.com/fonts/material-symbols-outlined).
